...
Wymagania hulli są wspólne, ale gałęzie narzędzi nie. Inwestycja w lasery przechodzi z małych hulli do Zealota, gałąź dronowa kończy się jako główna broń na Arbitratorze, a Sacrilege rozpoczyna osobną gałąź missiles dopiero na poziomie HAC. Armor Buffer jest wspólną bazą tanku; Active Armor dodaje się wyłącznie do fita z local repairerem.
