...
A modular plan for **Light T2** competency. Train it only when the selected hull or doctrine actually uses it.

> **Milestone:** IMPROVED is the practical T2 light-drone access milestone; STANDARD develops specialization further.
